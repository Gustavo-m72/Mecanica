...
<label name = "nome_nome">Identificar mecanico responsavel pela ordem de servico::</label>
    <div>
...
<?php
    ...
    if (isset($_POST['buscar'])) {
        ...
        $sql = "SELECT m.nome AS mecanico, o.id, o.entrada, o.saida,
        v.placa,
        pf.nome,pf.CPF,
        pj.CNPJ, pj.nomefantasia,
        c.contato
        FROM ordem_servico o
        INNER JOIN mecanico m ON o.mecanico_id = m.id
